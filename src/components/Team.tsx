...
const Team = () => {
  ...
  const teamMembers = [
    ...
    { id: 'm17', name: 'Nusrat Jahan', role: 'MEMBER', team: 'Autonomous & Navigation Team', department: 'Department of CSE', image: nusrat, category: 'member', email: 'nananya2430669@bscse.uiu.ac.bd', linkedin: '' },
