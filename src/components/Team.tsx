...
const Team = () => {
  ...
  const teamMembers = [
    ...
    { id: 'm23', name: 'Dip', role: 'MEMBER', team: 'PR & Marketing Team', department: 'Department of CSE', image: jarin, category: 'member', email: '', linkedin: '' },
    ...
    { id: 'm17', name: 'Nusrat Jahan', role: 'MEMBER', team: 'Autonomous & Navigation Team', department: 'Department of CSE', image: jarin, category: 'member', email: 'jzahid2330034@bscse.uiu.ac.bd', linkedin: 'https://www.linkedin.com/in/jahrin-binte-zahid-28bb09352?utm_source=share_via&utm_content=profile&utm_medium=member_android' },
    { id: 'm18', name: 'Bahar Shahriyar', role: 'MEMBER', team: 'Web & Communication Team & PR & Marketing Team', department: 'Department of CSE', image: member8, category: 'member', email: ' bhr.shkh@gmail.com', linkedin: 'https://www.linkedin.com/in/bahauddin-sheik-bahar-6776ba152?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app' },
